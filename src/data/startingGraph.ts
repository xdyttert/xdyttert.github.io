...
export const startingGraphNodes: Nodes = {
  ...
  node10: { name: "N10", distanceDijkstra: 0, distanceSpira: 0, distanceZwick: 0, isInQDijkstra: false, exploredBFS: false, solvedDijkstra: false, solvedSpira: false, solvedZwick: false, prevDijkstra: null, prevSpira: null, prevZwick: null, colorDijkstra: "blue", colorSpira: "blue", colorZwick: "blue", isOut: true, active: true, outDijkstra: [], outSpira: new SortedLinkedList<Edge>(compareFunc), outZwick: new SortedLinkedList<Edge>(compareFunc), in: new SortedLinkedList<Edge>(compareFunc), req: new SortedLinkedList<Edge>(compareFunc) },
}
...
export const startingGraphEdges: Edges = {
  ...
  edge13: { source: "node7", target: "node10", weight: 5, colorDijkstra: "blue", colorSpira: "blue", colorZwick: "blue", PKeySpira: 0, PKeyZwick: 0, isInPSpira: false, isInQZwick: false, isInPZwick: false, inPertinent: false, outPertinent: false },
} 

export const startingGraphLayouts: Layouts = {
  nodes: {
    node1: { x: 10, y: 10 },
    node2: { x: 120, y: 10 },
    node3: { x: 230, y: 10 },
...
export function makeEdgesLists(nodes: Nodes, edges: Edges){
  for (const key in nodes) {
    const node = nodes[key]
    node.outDijkstra = []
    node.outSpira = new SortedLinkedList<Edge>(compareFunc)
    node.outZwick = new SortedLinkedList<Edge>(compareFunc)
    node.in = new SortedLinkedList<Edge>(compareFunc)
  }
